...
import Logo from "./assets/CKS_sin_fondo.png";
...
const OPENSEA_LINK =
  "https://testnets.opensea.io/collection/cryptonikasnft-wiia0r0v8u";
const TOTAL_MINT_COUNT = 30;
const CONTRACT_ADDRESS = "0xc4C8c70901a993c6C23e4E0849BaF5d57E173C10";
  ...
  const askContractToMintNft = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        console.log("Mining...please wait. Mother fucker!!!");
        await nftTxn.wait();
        setIsLoading(false);
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Cryptonikas NFT Collection</p>
        </div>
        <div>
          <img className="logo-cryptonikas" src={Logo} />
        </div>
        <div
          style={{
            display: "flex",
